...
#include "GameContent\Entities\Enemies\E_ArtilBot.h"
#include "GameContent\Entities\Enemies\E_Drone.h"
#include "GameContent\Entities\Enemies\E_Jelly.h"
#include "GameContent\Entities\Enemies\E_Medic.h"
#include "GameContent\Entities\StaticEntity.h"
#include "GameContent\Entities\Players\Robot\P_Robot.h"
#include "GameContent\Entities\Players\Ranger\P_Ranger.h"
#include "GameContent\Levels\LevelTest.h"
#include "Maths\Pathfinder.h"
...
void Game::ProcessInput(GLfloat dt) {
	...
	if (Util::CONTROLLER_SUPPORT) {
		...
		if (controlledPlayers > (GLuint) sPlayers.size()) {
			controlledPlayers = (GLuint) sPlayers.size();
		}
...
void Game::Update(GLfloat dt) {
	...
	Metrics::GetMetric("GameMetric").Loop();
