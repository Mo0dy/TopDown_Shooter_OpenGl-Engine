...
Camera::Camera():pos(-1.0f, -1.0f), minSizeHeight(30)
{
}
...
void Camera::updatePos(GLuint width, GLuint height, std::vector<Player*> players) {
	
	GLfloat WHratio = width / (GLfloat) height * 2;
